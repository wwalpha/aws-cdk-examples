...
export default (parent: Construct, props: CloudFrontInput, identity: string) => new cloudformation.BucketPolicyResource(
  parent,
  'BucketPolicyResource',
  {
    bucket: props.bucketName as string,
